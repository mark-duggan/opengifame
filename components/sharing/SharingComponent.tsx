...
import SharingEmbed from "./SharingEmbed";
...
const SharingComponent: React.FC<ISharingComponentProps> = ({gif}) => {
  return (
    <div className="flex gap-6 mt-6">
      ...
      <Disclosure>
        <Disclosure.Button className="flex justify-between flex-row">
          <ImEmbed2
            className="w-6 h-6 transition fill-zinc-500 group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300"
          />
          {/*<HiChevronRight className="ui-open:rotate-90 ui-open:transform"/>*/}
        </Disclosure.Button>
        <Transition
